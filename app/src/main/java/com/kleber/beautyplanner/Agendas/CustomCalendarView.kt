...
import com.kleber.beautyplanner.Cliente.ClienteModel
...
/*    var spinner: Spinner? = null
    ...
    private lateinit var nomesCliente: ArrayList<String>
    ...
    constructor(context: Context?, attrs: AttributeSet?) : super(context, attrs) {
        ...
        gridView!!.onItemClickListener =
            OnItemClickListener { parent, view, position, id ->
                ...
                //setContentView(R.layout.add_newevent_layout)
/*                spinner = findViewById(R.id.spinnerCliente)
                nomesCliente = ArrayList()
                dbref = FirebaseDatabase.getInstance().getReference("Clientes")
                arrayAdapter = ArrayAdapter(getContext(),android.R.layout.simple_spinner_dropdown_item,nomesCliente)

                dbref.addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(@NonNull snapshot: DataSnapshot) {
                        if (snapshot.exists()) {
                            for (chilSnapshot in snapshot.children) {
                               // val spinnerNome =chilSnapshot.child("vclienteNome").getValue(String::class.java)
                                nomesCliente.add(chilSnapshot.child("vclienteNome").getValue().toString())
                            }
                            *//*for (chilSnapshot in snapshot.children) {
                            val spinnerNome = chilSnapshot.child("Clientes").getValue(String::class.java)
                            nomesCliente.add(spinnerNome!!)
                        }*//*
